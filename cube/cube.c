...
#include "cube-nc.vert.inc"
    };
    demo->vert_shader_module = demo_prepare_shader_module("cube-nc.vert", demo, vs_code, sizeof(vs_code));
}

static void demo_prepare_fs(struct demo *demo) {
    const uint32_t fs_code[] = {
#include "cube-nc.frag.inc"
    };
    demo->frag_shader_module = demo_prepare_shader_module("cube-nc.frag", demo, fs_code, sizeof(fs_code));
}
...
#define NUM_DYNAMIC_STATES 2 /*Viewport + Scissor*/
    ...
    shaderStages[0].pNext = &shaderDescriptorSet_vs;

    shaderStages[1].sType = VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO;
    shaderStages[1].stage = VK_SHADER_STAGE_FRAGMENT_BIT;
    shaderStages[1].module = demo->frag_shader_module;
    shaderStages[1].pName = "main";
    shaderStages[1].pNext = &shaderDescriptorSet_fs;
